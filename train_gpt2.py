...
if __name__ == "__main__":
    ...
    parser.add_argument("--model", type=str, default="gpt2", help="gpt2|gpt2-medium|gpt2-large|gpt2-xl|d12|d24|d36|d48s|d48")
    ...
    assert args.model in {"gpt2", "gpt2-medium", "gpt2-large", "gpt2-xl", "d12", "d24", "d36", "d48s", "d48"}
    ...
    if args.model[0] == "d":
        ...
        model_config = {
            ...
            "d48s": GPTConfig(block_size=1024, vocab_size=50257, n_layer=48, n_head=20, n_embd=1280),
    ...
    if master_process and args.write_tensors and (not args.inference_only):
        ...
        model_to_size = {"gpt2": "124M", "gpt2-medium": "355M", "gpt2-large": "774M", "gpt2-xl": "1558M", "d48s": "d48s"}
