...
# -----------------------------------------------------------------------------
DATA_CACHE_DIR = os.path.join(os.path.dirname(__file__), "email")
...
def tokenize(model_desc):
    ...
    data_filename = os.path.join(DATA_CACHE_DIR, "mobile_email.txt")
    ...
    # save to file
    val_filename = os.path.join(DATA_CACHE_DIR, "mobile_email_val.bin")
    train_filename = os.path.join(DATA_CACHE_DIR, "mobile_email_train.bin")
